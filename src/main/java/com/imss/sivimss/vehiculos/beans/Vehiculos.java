...
public class Vehiculos {
    ...
    public DatosRequest buscarVehiculos(DatosRequest request) throws IOException {
        Gson json = new Gson();
        BuscarVehiculosRequest  buscarRequest = json.fromJson(String.valueOf(request.getDatos().get(AppConstantes.DATOS)),BuscarVehiculosRequest.class);
        ...
        queryUtil.select("VH.ID_VEHICULO",
                ...
                .join("SVT_MTTO_SOLICITUD MS", "MS.ID_MTTOVEHICULAR = MS.ID_MTTOVEHICULAR")
                .join("SVC_MTTO_ESTADO ME", "ME.ID_MTTOESTADO = MV.ID_MTTOESTADO")
